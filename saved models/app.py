...
diabetes_model = pickle.load(open(f'{working_dir}/saved models/diabetes.pkl','rb'))
heart_disease_model = pickle.load(open(f'{working_dir}/saved models/heart.pkl','rb'))
kidney_disease_model = pickle.load(open(f'{working_dir}/saved models/kidney.pkl','rb'))
